...
__decorate([
    typeorm_1.ManyToOne(type => storeCategory_entity_1.StoreCategory, storeCategory => storeCategory.products),
    __metadata("design:type", storeCategory_entity_1.StoreCategory)
], Product.prototype, "storeCategory", void 0);
__decorate([
    typeorm_1.OneToMany(type => cartItem_entity_1.CartItem, cartItem => cartItem.product),
